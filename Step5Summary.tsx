        ...
        <div className="border-[1.5px] border-black">
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="text-[8.5pt]">
              ...
              <tr className="border-t border-black">
                <td className="border-r border-black p-0 align-top">
                  <div className="p-2 relative min-h-[90px]">
                    {hotels[0] ? (
                      <div className="leading-tight">
                        BSH x <span className="font-bold">{hotels[0].bilangan}</span> sebanyak RM <span className="font-bold">{hotels[0].kadar.toFixed(2)}</span>/hari.<br/>
                        <div className="text-[7.5pt] mt-1">(Termasuk Bayaran Perkhidmatan & Cukai Perkhidmatan)</div>
                        <div className="mt-8 text-[7.5pt]">[Resit .....................................................]</div>
                      </div>
                    ) : (
                      <div className="leading-tight">
                        BSH x ................. sebanyak RM ................./hari.<br/>
                        <div className="text-[7.5pt] mt-1">(Termasuk Bayaran Perkhidmatan & Cukai Perkhidmatan)</div>
                        <div className="mt-8 text-[7.5pt]">[Resit .....................................................]</div>
                      </div>
                    )}
                    <div className="absolute right-0 top-0 h-full border-l border-black w-24 flex">
                      ...
                      <div className="flex-1 flex items-center justify-end px-1 font-bold">
                        {hotels[0] ? (hotels[0].bilangan * hotels[0].kadar).toFixed(2) : ''}
                      </div>
                    </div>
                  </div>
                </td>
              ...
              <tr className="border-t border-black">
                <td className="border-r border-black p-0 align-top">
                  <div className="p-2 relative min-h-[90px]">
                    {hotels[1] ? (
                      <div className="leading-tight">
                        BSH x <span className="font-bold">{hotels[1].bilangan}</span> sebanyak RM <span className="font-bold">{hotels[1].kadar.toFixed(2)}</span>/hari.<br/>
                        <div className="text-[7.5pt] mt-1">(Termasuk Bayaran Perkhidmatan & Cukai Perkhidmatan)</div>
                        <div className="mt-8 text-[7.5pt]">[Resit .....................................................]</div>
                      </div>
                    ) : (
                    ...
                    <div className="absolute right-0 top-0 h-full border-l border-black w-24 flex">
                      <div className="w-8 border-r border-black flex items-center justify-center font-bold">RM</div>
                      <div className="flex-1 flex items-center justify-end px-1 font-bold">
                        {hotels[1] ? (hotels[1].bilangan * hotels[1].kadar).toFixed(2) : ''}
                      </div>
                    </div>
                  </div>
                </td>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-t border-black font-bold">
                <th className="w-1/2 border-r border-black py-2 uppercase text-center text-[8.5pt]">TUNTUTAN ELAUN LOJING<br/>(SEMENANJUNG MALAYSIA)</th>
                <th className="w-1/2 py-2 uppercase text-center text-[8.5pt]">TUNTUTAN ELAUN LOJING<br/>(SABAH/ SARAWAK /LABUAN)</th>
              </tr>
            </thead>
            <tbody className="text-[8.5pt]">
              {/* Pengiraan Lojing */}
              <tr className="border-t border-black">
                <td className="border-r border-black p-0 align-top">
                  <div className="p-2 relative min-h-[45px]">
                    {lojingsOnly[0] ? (
                      <div className="leading-tight">Elaun Lojing x <span className="font-bold">{lojingsOnly[0].bilangan}</span> sebanyak RM <span className="font-bold">{lojingsOnly[0].kadar.toFixed(2)}</span>/hari.</div>
                    ) : (
                    ...
                    <div className="absolute right-0 top-0 h-full border-l border-black w-24 flex">
                      <div className="w-8 border-r border-black flex items-center justify-center font-bold">RM</div>
                      <div className="flex-1 flex items-center justify-end px-1 font-bold">
                        {lojingsOnly[0] ? (lojingsOnly[0].bilangan * lojingsOnly[0].kadar).toFixed(2) : ''}
                      </div>
                    </div>
                  </div>
                </td>
              ...
              {/* Alamat Lojing 1 */}
              <tr className="border-t border-black">
                <td className="border-r border-black p-3 align-top min-h-[140px]">
                  <div className="text-[8pt] mb-2">Tarikh Lojing: <span className="font-bold">{lojingsOnly[0]?.tarikh ? formatDate(lojingsOnly[0].tarikh) : '.........................'}</span></div>
                  <div className="text-[8pt]">Alamat Lojing: <br/> <span className="font-bold text-[7.5pt]">{lojingsOnly[0]?.alamat || '........................................................................................................................................................................................................................................................................................................'}</span></div>
                </td>
                <td className="p-3 align-top min-h-[140px]">
                  <div className="text-[8pt] mb-2">Tarikh Lojing: .........................</div>
                  <div className="text-[8pt]">Alamat Lojing: <br/> ........................................................................................................................................................................................................................................................................................................</div>
                </td>
              </tr>
              {/* Alamat Lojing 2 */}
              <tr className="border-t border-black">
                <td className="border-r border-black p-3 align-top min-h-[140px]">
                  <div className="text-[8pt] mb-2">Tarikh Lojing: <span className="font-bold">{lojingsOnly[1]?.tarikh ? formatDate(lojingsOnly[1].tarikh) : '.........................'}</span></div>
                  <div className="text-[8pt]">Alamat Lojing: <br/> <span className="font-bold text-[7.5pt]">{lojingsOnly[1]?.alamat || '........................................................................................................................................................................................................................................................................................................'}</span></div>
                </td>
                <td className="p-3 align-top min-h-[140px]">
                  <div className="text-[8pt] mb-2">Tarikh Lojing: .........................</div>
                  <div className="text-[8pt]">Alamat Lojing: <br/> ........................................................................................................................................................................................................................................................................................................</div>
              ...
              {/* Footer Jumlah RM per kolum */}
              <tr className="border-t-[1.5px] border-black font-bold">
                <td className="border-r border-black p-1 text-right relative pr-24 uppercase">Jumlah
                  <div className="absolute right-0 top-0 h-full border-l border-black w-24 flex">
                    <div className="w-8 border-r border-black flex items-center justify-center">RM</div>
                    <div className="flex-1 flex items-center justify-end px-1">{partBTotal.toFixed(2)}</div>
                  </div>
                </td>
                <td className="p-1 text-right relative pr-24 uppercase">Jumlah
                  <div className="absolute right-0 top-0 h-full border-l border-black w-24 flex">
                    <div className="w-8 border-r border-black flex items-center justify-center">RM</div>
                    <div className="flex-1"></div>
                  </div>
              ...
              {/* JUMLAH (BAHAGIAN B) Keseluruhan */}
              <tr className="border-t border-black font-black bg-gray-50/30">
                <td colSpan={2} className="text-right p-2 pr-24 relative uppercase text-[9.5pt]">JUMLAH (BAHAGIAN B)
