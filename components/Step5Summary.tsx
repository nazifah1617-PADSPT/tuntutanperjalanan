                ...
                <tr>
                  ...
                  <td className="px-3 py-4 leading-normal">
                    ...
                    {(j.pergi.tolMasuk || j.pergi.tolKeluar) && (
                      <div className="text-[7.5pt] text-blue-700 bg-blue-50/50 p-1.5 rounded border border-blue-100 mt-2">
                        <span className="font-bold uppercase tracking-tighter">Butiran Tol (P):</span> {j.pergi.tolMasuk || '-'} &rarr; {j.pergi.tolKeluar || '-'}
                      </div>
                    )}
                  </td>
                  ...
                  <tr>
                    ...
                    <td className="px-3 py-4 leading-normal">
                      ...
                      {(j.balik.tolMasuk || j.balik.tolKeluar) && (
                        <div className="text-[7.5pt] text-amber-700 bg-amber-50/50 p-1.5 rounded border border-amber-100 mt-2">
                          <span className="font-bold uppercase tracking-tighter">Butiran Tol (B):</span> {j.balik.tolMasuk || '-'} &rarr; {j.balik.tolKeluar || '-'}
                        </div>
                      )}
                    </td>
